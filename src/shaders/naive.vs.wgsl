...
@group(${bindGroup_scene}) @binding(0) var<uniform> uniformsBuffer: CameraUniforms;
...
fn main(in: VertexInput) -> VertexOutput
{
    ...
    out.fragPos = uniformsBuffer.viewProjMat * modelPos;  // TODO-1.3: replace ??? with the view proj mat from your CameraUniforms uniform variable
