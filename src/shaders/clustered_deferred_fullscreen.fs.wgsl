...
@group(1) @binding(0) var gBufferAlbedoTexture: texture_2d<f32>;
@group(1) @binding(1) var gBufferNormalTexture: texture_2d<f32>;
@group(1) @binding(2) var gBufferDepthTexture: texture_depth_2d;
...
fn main(input: VertexOutput) -> @location(0) vec4<f32> {
    ...
    let depth = textureSample (gBufferDepthTexture, texSampler, uv);
