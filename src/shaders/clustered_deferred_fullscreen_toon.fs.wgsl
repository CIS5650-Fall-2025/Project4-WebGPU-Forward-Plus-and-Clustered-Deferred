...
// fn main(in : FragmentInput) -> @location(0) vec4f
{
    ...
    let ambientLight = vec3f(0.0, 0.0, 0.0);
    ...
    for (var lightIdx = 0u; lightIdx < numLights; lightIdx++) {
        ...
        totalLightContrib += calculateLightContribToonShading(light, worldpos, normalize(cameraUniforms.cameraPos - worldpos), normal, ambientLight);
    }
