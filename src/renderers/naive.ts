    ...
    constructor(stage: Stage) {
        ...
        this.sceneUniformsBindGroupLayout = renderer.device.createBindGroupLayout({
            ...
            entries: [
                ...
                {
                    binding: 0,  // Camera uniforms binding
                    visibility: GPUShaderStage.VERTEX,  // Visible to vertex shader only
                    buffer: { type: "uniform" }  // Uniform buffer type
                },
                { // lightSet
                    binding: 1,
        ...
        this.sceneUniformsBindGroup = renderer.device.createBindGroup({
            ...
            entries: [
                ...
                {
                    binding: 0,  // Camera uniforms binding index
                    resource: { buffer: this.camera.uniformsBuffer }  // Camera uniform buffer
                },
                {
                    binding: 1,
